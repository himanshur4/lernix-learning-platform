  ...
  return (
    ...
    <div className='flex justify-center w-full'>
      <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-900/50 md:border-gray-900/40 rounded-3xl transition-transform duration-300 hover:-translate-y-1 hover:drop-shadow-xl md:rounded-4xl'>
        ...
        <button type='submit' className='bg-gradient-to-tl from-teal-600 to-teal-800 rounded-3xl text-white md:px-10 px-7 md:py-3 py-2 mx-1 cursor-pointer transition-transform duration-300 hover:-translate-x-1  hover:shadow-2xl hover:scale-110'>Search</button>
      </form>
