...
const MyCourses = () => {
  ...
  return (
    <div className="flex-1 min-h-screen bg-gradient-to-b from-fuchsia-100 to-white">
      <div className="p-4 md:p-8 max-w-7xl mx-auto">
        ...
        {courses && courses.length > 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-fuchsia-100 overflow-hidden">
            <div className="overflow-x-auto">
              {/* Desktop Table View */}
              <table className="w-full hidden md:table">
                <thead>
                  <tr className="bg-fuchsia-50 text-left">
                    ...
                    <tr key={course._id} className="hover:bg-fuchsia-50 transition-colors duration-150">
                      ...
                      <td className="px-4 py-4 text-gray-700">
                        <div className="flex items-center">
                          <span className="bg-fuchsia-100 text-fuchsia-800 py-1 px-2 rounded-full text-xs font-medium">
