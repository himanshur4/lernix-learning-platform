...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-4 md:gap-8 md:p-8 md:pb-0 p-3 pt-6 pb-6 bg-gradient-to-b from-fuchsia-100'>
      <div className="w-full space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-xl md:text-2xl font-bold text-fuchsia-900">Dashboard</h1>
          <p className="text-sm md:text-base text-fuchsia-700">Welcome back to your educator dashboard!</p>
        </div>

        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5'>
          <div className="flex items-center gap-3 md:gap-4 bg-white p-4 md:p-5 w-full rounded-xl shadow-md border-l-4 border-fuchsia-600 transition-all duration-300 hover:shadow-lg">
            <img
            ...
            />
            <div>
              <p className="text-xl md:text-2xl font-semibold text-fuchsia-900">{dashboardData.enrolledStudentsData.length}</p>
              <p className='text-xs md:text-sm text-fuchsia-700'>Total Enrollments</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 md:gap-4 bg-white p-4 md:p-5 w-full rounded-xl shadow-md border-l-4 border-fuchsia-600 transition-all duration-300 hover:shadow-lg">
            ...
            />
            <div>
              <p className="text-xl md:text-2xl font-semibold text-fuchsia-900">{dashboardData.totalCourses}</p>
              <p className='text-xs md:text-sm text-fuchsia-700'>Total Courses</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 md:gap-4 bg-white p-4 md:p-5 w-full rounded-xl shadow-md border-l-4 border-fuchsia-600 transition-all duration-300 hover:shadow-lg">
            ...
            />
            <div>
              <p className="text-xl md:text-2xl font-semibold text-fuchsia-900">{currency} {dashboardData.totalEarnings.toFixed(2)}</p>
              <p className='text-xs md:text-sm text-fuchsia-700'>Total Earnings</p>
            </div>
          </div>
        </div>
        ...
        <div className='bg-white p-3 md:p-6 rounded-xl shadow-md border-t-4 border-fuchsia-600'>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4 md:mb-6">
            <h2 className="text-lg md:text-xl font-semibold text-fuchsia-900">Latest Enrollments</h2>
              ...
              <table className='w-full'>
                ...
                <tbody className='text-xs md:text-sm divide-y divide-fuchsia-100'>
                  {dashboardData.enrolledStudentsData.map((item, index) => (
                    <tr key={index} className='hover:bg-fuchsia-50 transition-colors duration-200'>
          ...
          {dashboardData.enrolledStudentsData.length === 0 && (
            <div className="text-center py-6 md:py-8 text-fuchsia-700 text-sm md:text-base">
