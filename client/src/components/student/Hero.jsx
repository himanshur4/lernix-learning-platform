...
const Hero = () => {
  return (<>
    <div className='flex flex-col items-center justify-center w-full sm:pt-23 md:pt-27 lg:pt-30 pt-20 px-7 md:px-0 space-y-7 text-center  bg-gradient-to-b from-fuchsia-300 to-fuchsia-200 mb-0'>
