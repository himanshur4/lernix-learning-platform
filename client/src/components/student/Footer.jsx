...
const Footer = () => {
  return (
    <footer className='bg-gradient-to-br from-teal-600 to-teal-800 text-white md:px-36 text-left w-full mt-0 text-base'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            <button className='bg-teal-950 w-24 h-9 rounded-3xl text-white cursor-pointer transition-transform duration-300 hover:-translate-y-1 hover:drop-shadow-xl'>Subscribe</button>
          </div>
        </div>
